...
A Clojure library designed to explore a dataset related to animal bites.

## Usage

From the folder Animal-Bites/animal-bites run `lein repl` or `lein test`. The original CSV file for this project is located in the folder Animal-Bites/animal-bites.
